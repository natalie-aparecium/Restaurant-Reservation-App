...
// validates that the request body has required fields
...
// validates that the request body has valid fields for an update
...
// validates for the existence of the table
...
// validates for the existence of a reservation
...
// validates the table capacity can accomodate the number of people
...
// validates if a table is occupied
...
// validates if a table is not occupied
...
// validates whether the reservation status is seated
...
// updates the table status to finished
